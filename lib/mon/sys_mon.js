...
exports.cpuUtils = function(callback){
    require('child_process').exec('vmstat', function(error, stdout, stderr) {
        ...
        var cpuutils = []
        cpuutils[0] = parseFloat(cpu_info[0])
        cpuutils[1] = parseFloat(cpu_info[1])
        cpuutils[2] = parseFloat(cpu_info[10])
        cpuutils[3] = parseFloat(cpu_info[11])
        cpuutils[4] = parseFloat(cpu_info[12])
        cpuutils[5] = parseFloat(cpu_info[13])
...
exports.memUtils = function(callback){
    ...
    require('child_process').exec('vmstat', function(error, stdout, stderr) {
        ...
        var memutils = []
        memutils[0] = _os.totalmem() / 1024 ;
        memutils[1] = parseFloat(mem_info[2])
        memutils[2] = parseFloat(mem_info[3])
        memutils[3] = parseFloat(mem_info[4])
        memutils[4] = parseFloat(mem_info[5])
        memutils[5] = parseFloat(mem_info[6])
        memutils[6] = parseFloat(mem_info[7])
        memutils[7] = parseFloat(mem_info[8])
        memutils[8] = parseFloat(mem_info[9])
